...
The source for the project website (https://policyattitudes.ca/) lives in `site/`. It's built with [Hugo](https://gohugo.io) (extended) and the [Researcher](https://github.com/ojroques/hugo-researcher) theme.
