...
- Pages are Markdown files in `site/content/`. Posts for the Updates page go in `site/content/updates/`; create one from `site/` with `hugo new updates/post-name.md`.
