...
# 1 survey blocks, one per survey (per wave for panel files). Each block
...
# bridge_clean.csv -- CVPA 2026 Bridge Survey, 12 demographic variables, 60 issue questions
survey(
  survey_id = "bridge_clean.csv",
  source    = "CVPA 2026 Bridge Survey",
  file_name = "bridge_clean.csv",
  demographics = function(..d) {
    ..d %>% transmute(
      # age <- age | age
      age = recode_values(as.numeric(..d[["age"]]), 1933 ~ 92, 1934 ~ 91, 1936 ~ 89, 1937 ~ 88, 1938 ~ 87, 1939 ~ 86, 1940 ~ 85, 1941 ~ 84, 1942 ~ 83, 1943 ~ 82, 1944 ~ 81, 1945 ~ 80, 1946 ~ 79, 1947 ~ 78, 1948 ~ 77, 1949 ~ 76, 1950 ~ 75, 1951 ~ 74, 1952 ~ 73, 1953 ~ 72, 1954 ~ 71, 1955 ~ 70, 1956 ~ 69, 1957 ~ 68, 1958 ~ 67, 1959 ~ 66, 1960 ~ 65, 1961 ~ 64, 1962 ~ 63, 1963 ~ 62, 1964 ~ 61, 1965 ~ 60, 1966 ~ 59, 1967 ~ 58, 1968 ~ 57, 1969 ~ 56, 1970 ~ 55, 1971 ~ 54, 1972 ~ 53, 1973 ~ 52, 1974 ~ 51, 1975 ~ 50, 1976 ~ 49, 1977 ~ 48, 1978 ~ 47, 1979 ~ 46, 1980 ~ 45, 1981 ~ 44, 1982 ~ 43, 1983 ~ 42, 1984 ~ 41, 1985 ~ 40, 1986 ~ 39, 1987 ~ 38, 1988 ~ 37, 1989 ~ 36, 1990 ~ 35, 1991 ~ 34, 1992 ~ 33, 1993 ~ 32, 1994 ~ 31, 1995 ~ 30, 1996 ~ 29, 1997 ~ 28, 1998 ~ 27, 1999 ~ 26, 2000 ~ 25, 2001 ~ 24, 2002 ~ 23, 2003 ~ 22, 2004 ~ 21, 2005 ~ 20, 2006 ~ 19),
      ...
      degree = recode_values(as.numeric(..d[["education"]]), 1:5 ~ 0, 6:8 ~ 1),
      # gender <- gender | How would you describe your gender?
      gender = recode_values(as.numeric(..d[["gender"]]), 0 ~ 0, 1 ~ 1, 2:3 ~ 2),
      # mother_tongue <- mother_tongue | mother_tongue
      mother_tongue = recode_values(as.numeric(..d[["mother_tongue"]]), 1 ~ 2, 2 ~ 1, 3 ~ 3, 4 ~ 4),
      # province <- province | province
      province = in_range(..d[["province"]], 10, 60),
      # region <- province | province
      region = recode_values(as.numeric(..d[["province"]]), 10:13 ~ 1, 24 ~ 2, 35 ~ 3, 46:48 ~ 4, 59 ~ 5, 60 ~ 6),
      # survey_mode <- assigned by hand | assigned by hand; not in the survey file
      survey_mode = rep(2, nrow(..d)),
      # union_household <- union | union
      union_household = recode_values(as.numeric(..d[["union"]]), 1 ~ 0, 2 ~ 1),
      # vote_intention <- vote_intention | vote_intention
      vote_intention = recode_values(as.numeric(..d[["vote_intention"]]), 1 ~ 6, 2 ~ 2, 3 ~ 10, 4 ~ 1, 5 ~ 3, 6 ~ 9, 9999 ~ 99),
